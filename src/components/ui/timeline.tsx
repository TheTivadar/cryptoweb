  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        Így Építettük Fel Az Alegex-et
        </h2>
        <p className="text-neutral-300 text-sm md:text-base max-w-sm">
          Már több mint egy éve dolgozzunk az Alegex AI-on. Lépésről Lépésre az Élvonalba
        </p>
      </div>

      <div ref={ref} className="relative w-full md:max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-5 md:h-10 absolute left-3 md:left-3 w-5 md:w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
