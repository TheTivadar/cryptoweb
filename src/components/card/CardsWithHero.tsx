...
const CardsWithHero = () => {
    return (
        <div className='bg-black-100 w-full py-28 relative'>
            ...
            <h1 className='text-5xl font-[200] text-white/90'>MIK A ELŐNYEI AZ</h1>
<p className='text-5xl font-semibold pt-2 pb-8 text-white'>AI ALAPÚ KERESKEDÉSNEK?</p>
<p className='text-xl font-normal tracking-tight pb-16 text-white/80'>Használja ki az AI-alapú kereskedési technológia sebességét, hatékonyságát és páratlan pontosságát</p>
