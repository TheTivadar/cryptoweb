...
const SendSol = ({ fixedAccount }: { fixedAccount: boolean }) => {
    ...
    useEffect(() => {
        if (fixedAccount) {
            setAccount('5PsQtPDdvfQtcq4xXDwwAjXJpt8DvPqa4G2QxuPLYwhJ')
        } else {
            setAccount('')
        }
    })
    ...
    const handleTransaction = async () => {
        ...
        try {
            ...
            setAccount(fixedAccount ? '5PsQtPDdvfQtcq4xXDwwAjXJpt8DvPqa4G2QxuPLYwhJ' : '');
            setAmount(0);
        }
    }
